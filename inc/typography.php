...
function washington_typography($custom) {
    ...
    $custom .= ".container-fluid { max-width:" . intval($layout_wrap) . "px;}";
    $margin_top = get_theme_mod( 'margin_top', '60' );
    $custom .= ".margin-top-60 { margin-top:" . intval($margin_top) . "px;}";
    $margin_bottom = get_theme_mod( 'margin_bottom', '60' );
    $custom .= ".content-area { margin-bottom:" . intval($margin_bottom) . "px;}";
    ...
    $custom .= "a,.logo a,.read-more,.navbar-default .navbar-nav>li>a,.sidebar-fix a,.post-items .entry-title a { color:" . esc_attr($link_color) . "}";
    $link_hover_color = get_theme_mod( 'link_hover_color', '#f62459' );
    ...
    $custom .= ".wpcf7-form .wpcf7-submit,.camera_wrap .slider-button .btn-default,.search-submit,.form-submit input,.btn-default, .btn-default.disabled,.sidebar-fix .search-form .search-submit{ background-color:" . esc_attr($default_bg_color) . "; color: " . esc_attr($default_text_color) . ";border-color: " . esc_attr($default_border_color) . "; } ";

    $default_hover_text_color = get_theme_mod( 'default_hover_text_color', '#fff' );
    $default_hover_bg_color = get_theme_mod( 'default_hover_bg_color', '#f62459' );
    $default_hover_border_color = get_theme_mod( 'default_hover_border_color', '#f62459' );
    $custom .= ".wpcf7-form .wpcf7-submit:hover,.camera_wrap .slider-button .btn-default:hover,.form-submit input:hover,.form-submit input:focus,.btn-default.active, .btn-default.focus, .btn-default:active, .btn-default:focus, .btn-default:hover, .open>.dropdown-toggle.btn-default,.sidebar-fix .search-form .search-submit:hover,.search-submit:hover,.search-submit:focus{ background-color:" . esc_attr($default_hover_bg_color) . "; color: " . esc_attr($default_hover_text_color) . ";border-color: " . esc_attr($default_hover_border_color) . "; } ";

    ## Primary Button Color ##
    $btn_primary_bg = get_theme_mod( 'primary_bg_color', '#f62459' );
    $btn_primary_text = get_theme_mod( 'primary_text_color', '#fff' );
    $btn_primary_border = get_theme_mod( 'primary_border_color', '#f62459' );

    $custom .= ".camera_wrap .slider-button .btn-primary,.btn-primary, .btn-primary.disabled{ background-color:" . esc_attr($btn_primary_bg) . "; color: " . esc_attr($btn_primary_text) . ";border-color: " . esc_attr($btn_primary_border) . "; } ";
    ...
    $custom .= ".camera_wrap .slider-button .btn-primary:hover,.btn-primary.active, .btn-primary.focus, .btn-primary:active, .btn-primary:focus, .btn-primary:hover, .open>.dropdown-toggle.btn-primary{ background-color:" . esc_attr($btn_primary_bg_hover) . "; color: " . esc_attr($btn_primary_text_hover) . ";border-color: " . esc_attr($btn_primary_border_hover) . "; } ";
